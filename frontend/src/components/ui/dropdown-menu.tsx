...
function DropdownMenuLabel({
  ...
  return (
    <div
      ...
      className={cn(
        "px-2 py-1.5 text-xs font-semibold text-gray-400 uppercase tracking-wide select-none",
        inset && "pl-8",
        className
      )}
      {...props}
...
function DropdownMenuItem({
  ...
  return (
    <MenuPrimitive.Item
      ...
      className={cn(
        "relative flex cursor-pointer items-center gap-2.5 rounded-lg px-3 py-2",
        "text-sm text-gray-700 outline-none select-none",
